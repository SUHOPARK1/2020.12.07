...
@Configuration
@MapperScan(basePackages = {"com.example.doit.repositories"})
public class MyBatisConfig {
    @Bean public SqlSessionFactory sqlSessionFactory(DataSource dataSource)throws Exception{
        ...
        sqlSessionFactory.setMapperLocations(resolver.getResources("classpath:com/example/doit/repositories/*.xml"));
